...
import banner1 from '../assets/online-shopping  banner .jpg'
import banner2 from '../assets/online-shopping banner.jpg'
...
const DashHome = () => {
  const Products1 = [
    { id: 1, img:'https://projectpoint.in/image/cache/catalog/CFR_Resistor_Kit-1280x720.jpg', 
      name: 'Resistors Pack - 49 Values (100 To 1M Ohm)',
       price: '200.0',
       description:`490 Pieces, 49 Values (100 Ohms to 1M Ohms) Assorted, Carbon Film Resistors, 5% 0.25W Resistor Kit.
Great Kit FOR STUDENTS AND HOBBYIST. The Kit consists of 490 pieces different values of resistors. Each value will be in lot of 10 pieces, Individually Wrapped and Labelled.
E12 Series (100E, 120E, 150E, 180E, 220E, 270E, 330E, 390E, 470E, 560E, 680E, 820E, 1K, 1K2, 1K5, 1K8, 2K2, 2K7, 3K3, 3K9, 4K7, 5K6, 6K8, 8K2, 10K, 12K, 15K, 18K, 22K, 27K, 33K, 39K, 47K, 56K, 68K, 82K, 100K, 120K, 150K, 180K, 220K, 270K, 330K, 390K, 470K, 560K, 680K, 820K, 1M)`,
Availability:'Available 6 pcs In Stock',
Sold:"5 pcs",
Weight:"154.00g ±5%",
Category:"Resistors Assorted-Kits"  
 },
{ id: 2, img:'https://hubtronics.in/image/cache/catalog/RLC%20Images/MFR-550x550.jpg', 
...
{ id: 3, img:'https://m.media-amazon.com/images/I/517sCkbv+nL._AC_UF1000,1000_QL80_.jpg', 
      name: 'Resistor kit pack ',
       price: '200.0',
       description:`Assorted 150 Pieces 30 Values Resistor Kit 1/4 Watts For Electronics Projects.
Features:
100% Brand New & High Quality
Assorted Resistor Kit 150 Pieces Total Resistors, 30 Different values Resistors of 1/4 Watts
Type: Carbon Film Resistors, Power: 0.25 Watts, Tolerance: 5%
All Values Mentioned on the pictures
...
{ id: 4, img:'https://electroglobal.in/wp-content/uploads/2024/12/ELECRO-GLOBAL-EG00101-1.jpg', 
      name: '220K Ohm Resistor Pack', 
       price: '200.0',
       description:`220K Ohm Resistor Pack – High Quality 1/4W Resistors with Resistance Color Code (5% Tolerance)Introducing the 220K ohm, 1/4 Watt Resistor with 5% tolerance (Pack of 10), essential for electronics enthusiasts. These resistors are meticulously crafted to provide precise resistance and reliability across various applications.`,
Availability:'Available 6 pcs In Stock',
Sold:"16 pcs",
Weight:"154.00g ±5%",
Category:" Basic Resistors, Resistors, Resistors Packs"
 },
{ id: 5, img:'https://i.ebayimg.com/images/g/8eAAAOSwiHFdVTTB/s-l1600.webp', 
      name: '1/2W 0.5W Metal Film Resistor 1% Toleranc', 
       price: '200.0',
       description:`220K Ohm Resistor Pack – High Quality 1/4W Resistors with Resistance Color Code (5% Tolerance)Introducing the 220K ohm, 1/4 Watt Resistor with 5% tolerance (Pack of 10), essential for electronics enthusiasts. These resistors are meticulously crafted to provide precise resistance and reliability across various applications.`,
Availability:'Available 6 pcs In Stock',
Sold:"16 pcs",
...
Category:" Basic Resistors, Resistors, Resistors Packs"
  ...
  const Products2 = [
    { id: 1, img:'https://www.flyrobo.in/image/cache/wp/gj/50-watt-soldering-iron-siron/50-watt-soldering-iron-siron-1%20(3)-1100x1100.webp', 
...
Category:"Electronics"
    ...
    { id: 2, img:`https://www.flyrobo.in/image/cache/wp/gj/solder-wire-40-gsm-for-most-electrical-repair-soldering-purpose/solder-wire-40-gsm-for-most-electrical-repair-soldering-purpose1-1100x1100.webp`, 
...
Category:"Electronics"
    ...
    { id: 3, img:`https://www.flyrobo.in/image/cache/wp/gj/product/20cm-male-to-female-jumper-cable-wire-for-arduino-10pcs-1100x1100.webp`, 
      name: '20cm Male To Female Jumper Cable Wire',
       price: '200.0',
...
Category:"Electronics"
    ...
    { id: 4, img:`https://www.flyrobo.in/image/cache/wp/gj/Breadboard/gl-12-1100x1100.webp`, 
...
Category:"Electronics"
    ...
    { id: 5, img:`https://www.flyrobo.in/image/cache/wp/gj/ad620-microvolt-millivolt-voltage-amplifier-module/ad620-microvolt-millivolt-voltage-amplifier-module1-1100x1100w.webp`, 
...
Category:"Electronics"
    ...
    { id: 6, img:`https://www.flyrobo.in/image/cache/wp/gj/lm386-audio-amplifier-module/lm386-audio-amplifier-module-10-1100x1100w.webp`, 
...
const Products3 = [
    { id: 1, img:'https://www.flyrobo.in/image/cache/wp/gj/arduino-nano-v3.0-atmega328p-ch340-chip-i-type-c-soldered/arduino-nano-v3.0-atmega328p-ch340-chip-i-type-c-soldered9-1100x1100.webp', 
      name: 'Arduino Nano V3.0 ATmega328P CH340 Chip I Type-C ',
       price: '200.0',
...
Category:"Resistors Assorted-Kits"
    ...
    { id: 2, img:'https://www.flyrobo.in/image/cache/wp/ge/40-pin-avr-project-board-for-atmel-microcontroller/40-pin-avr-project-board-for-atmel-microcontroller16-1100x1100.webp', 
...
Category:"Resistors Assorted-Kits"
    ...
    { id: 3, img:`https://www.flyrobo.in/image/cache/wp/gj/product/arduino-uno-r3-+-cable-for-arduino-uno-1100x1100.webp`, 
...
Category:"Resistors Assorted-Kits"
    ...
    { id: 4, img:`https://www.flyrobo.in/image/cache/wp/gj/arduino-uno-r3-smd-board-cable-for-arduino-uno-1/arduino-uno-r3-smd-board-cable-for-arduino-uno-13-1100x1100.webp`, 
...
Category:"Resistors Assorted-Kits"
    ...
    { id: 5, img:`https://www.flyrobo.in/image/cache/wp/gj/product2/arduino-mega-r3-atmega2560-16au-development-board-1100x1100w.webp`, 
...
Category:"Resistors Assorted-Kits"
    ...
    { id: 6, img:`https://www.flyrobo.in/image/cache/wp/gj/product2/arduino-mega-r3-atmega2560-16au-development-board-1100x1100w.webp`, 
...
Category:"Resistors Assorted-Kits"
  ...
  const Products4 = [
     { id: 1, img:`https://www.flyrobo.in/image/cache/wp/gj/product/esp8266-esp-01-wifi-transceiver-wireless-module-1100x1100.webp `, 
...
Category:"Integrated low power 32-bit CPU could be used as an application processor"
     ...
     { id: 2, img:`https://www.flyrobo.in/image/cache/wp/gj/esp32-cam-wifi-bluetooth-development-board-with-ov2640-camera-module/esp32-cam-wifi-bluetooth-development-board-with-ov2640-camera-module-1100x1100.webp`, 
      name: 'ESP32 CAM WiFi Bluetooth Development Board with Camera ',
       price: '200.0',
...
Category:"SP32 CAM WiFi Bluetooth Development Board with OV2640 Camera Module."
     ...
     { id: 3, img:`https://www.flyrobo.in/image/cache/wp/gj/nodemcu-esp8266-cp2102-wifi-development-board/nodemcu-esp8266-cp2102-wifi-development-board2-1100x1100w.webp`, 
...
Category:"SP32 CAM WiFi Bluetooth Development Board with OV2640 Camera Module."
     ...
     { id: 4, img:`https://www.flyrobo.in/image/cache/wp/gj/esp-wroom-32-wifi-bluetooth-networking-smart-component-development-board/esp-wroom-32-wifi-bluetooth-networking-smart-component-development-board2-1100x1100.webp`, 
...
Category:" ESP-WROOM-32 WIFI Bluetooth Networking Smart Component Development Board "
     ...
     { id: 5, img:`https://www.flyrobo.in/image/cache/wp/ge/nodemcu-esp8266-wifi-plus-0.96-inch-oled-board/nodemcu-esp8266-wifi-plus-0.96-inch-oled-board1-1100x1100.webp`, 
      name: 'ESP-WROOM-32 WIFI Bluetooth Module (30PIN)',
       price: '200.0',
...
Category:" Nodemcu ESP8266 Wifi + 0.96 Inch OLED Board "
     ...
     { id: 6, img:`https://www.flyrobo.in/image/cache/wp/gj/esp8266-esp12f-serial-wifi-witty-cloud-development-board-with-mini-nodemcu/esp8266-esp12f-serial-wifi-witty-cloud-development-board-with-mini-nodemcu1-1100x1100.webp`, 
...
const Products5 = [
     { id: 1, img:`https://www.flyrobo.in/image/cache/wp/gj/product/ultrasonic-module-hc-sr04-distance-measuring-sensor-1100x1100.webp`,
...
Category:"Sensor Module Output Signal: Electric frequency signal, high-level 5V, low-level 0V."
     ...
     { id: 2, img:`https://www.flyrobo.in/image/cache/wp/gj/infrared_obstacle_avoidance_sensor/IR-Sensor-1100x1100.webp`,
...
Category:"Sensor Module Obstacle detector sensor"
     ...
     { id: 3, img:`https://www.flyrobo.in/image/cache/wp/gj/pir-motion-detector-sensor-module/pir-sensor-3-1100x1100.webp `,
...
Category:"Sensor Module Turn to Right, Distance Increases (About 7M); Turn to Left, Distance Reduce (About 3M)"
     ...
     { id: 4, img:`https://www.flyrobo.in/image/cache/wp/gj/soil-moisture-meter-andsoil-humidity-sensor-andwater-sensor-andsoil-hygrometer-for-ardunio/soil-moisture-meter-andsoil-humidity-sensor-andwater-sensor-andsoil-hygrometer-for-ardunio-1-1100x1100.webp`,
...
Category:"Sensor Module Dual output mode, analog output more accurate."
     ...
     { id: 5, img:`https://www.flyrobo.in/image/cache/wp/gj/product/am2302-dht22-temperature-and-humidity-sensor-module-1100x1100.webp`,
...
Category:"Sensor Module Full range temperature compensated"
     ...
     { id: 6, img:`https://www.flyrobo.in/image/cache/wp/gj/ds18b20_digital_temperature_sensor_module_for_arduino/ds18b20_digital_temperature_sensor_module_for_arduino11-1100x1100.webp`,
...
const Products6 = [
     { id: 1, img:`https://www.flyrobo.in/image/cache/wp/gj/max31865-rtd-platinum-pt100-pt1000-temperature-digital-voltage-converter/max31865-rtd-platinum-pt100-pt1000-temperature-digital-voltage-converter1-1100x1100w.webp`,
...
Category:"Sensor Module"
     ...
     { id: 2, img:`https://www.flyrobo.in/image/cache/wp/gj/lm393-photosensitive-ldr-sensor-module/lm393-photosensitive-ldr-sensor-module1-1100x1100.webp`,
...
Category:"Sensor Module"
     ...
     { id: 3, img:`https://www.flyrobo.in/image/cache/wp/gj/Color-sensor-TCS230-TCS3200-Color-Recognition-Sensor-Detector-Module-DC/color-sensor-tcs230-tcs3200-color-recognition-sensor-detector-module-1100x1100.webp`,
...
Category:"Sensor Module"
     ...
     { id: 4, img:`https://www.flyrobo.in/image/cache/wp/gj/raindrop-detection-sensor-module/raindrop-detection-sensor-module1-1100x1100.webp`,
...
Category:"Sensor Module"
     ...
     { id: 5, img:`https://www.flyrobo.in/image/cache/wp/gj/cjmcu-75-lm75-temperature-sensor-high-speed-i2c-development-board/cjmcu-75-lm75-temperature-sensor-high-speed-i2c-development-board1-1100x1100.webp`,
...
Category:"Sensor Module , stand-alone temperature controller"
     ...
     { id: 6, img:`https://www.flyrobo.in/image/cache/wp/gj/gas-sensor/MQ-2/MQ-2-1100x1100.webp`,
...
const Products7 = [
     { id: 1, img:`https://www.flyrobo.in/image/cache/wp/gJ/product/l298n-motor-driver-module-for-arduino-1100x1100.webp`,
...
Category:"motor driver"
     ...
     { id: 2, img:`https://www.flyrobo.in/image/cache/wp/gJ/product/l293d-motor-driver-shield-for-arduino-1100x1100.webp`,
...
Category:"motor driver"
     ...
     { id: 3, img:`https://www.flyrobo.in/image/cache/wp/gJ/product/16-channel-pwm-servo-motor-driver-i2c-module-1100x1100.webp`,
...
Category:"motor driver"
     ...
     { id: 4, img:`https://www.flyrobo.in/image/cache/wp/gJ/product/l293d-motor-drive-module-1100x1100.webp`,
...
Category:"motor driver"
     ...
     { id: 5, img:`https://www.flyrobo.in/image/cache/wp/gj/DRV8825/drv8825-stepper-motor-driver-with-aluminum-heat-sink-1100x1100.webp`,
...
Category:"motor driver"
     ...
     { id: 6, img:`https://www.flyrobo.in/image/cache/wp/gJ/Motor-and-Driver/tb6612fng-dual-motor-driver-module-1a-for-arduino-micro-controller-1100x1100.webp`,
...
const Products8 = [
     { id: 1, img:`https://www.flyrobo.in/image/cache/wp/gj/product/dc-3-6v-bo-gear-motor-with-plastic-tire-wheel-for-arduino-smart-car-1100x1100.webp`,
...
Category:" DC motor"
     ...
     { id: 2, img:`https://www.flyrobo.in/image/cache/wp/gj/200rpm-dc-3-12v-l-shape-bo-gear-motor-one-side-shaft-for-arduino-smart-car/200rpm-dc-3-12v-l-shape-bo-gear-motor-one-side-shaft-for-arduino-smart-car-5-1100x1100h.webp`,
...
Category:" DC motor"
     ...
     { id: 3, img:`https://www.flyrobo.in/image/cache/wp/gj/12v-500rpm-n20-metal-gear-motor/12v-500rpm-n20-metal-gear-motor1-1100x1100.webp`,
...
Category:" DC motor"
     ...
     { id: 4, img:`https://www.flyrobo.in/image/cache/wp/gj/high-torque-motor/1-1100x1100w.webp`,
...
Category:"gear motor"
     ...
     { id: 5, img:`https://www.flyrobo.in/image/cache/wp/gp/12v-60-rpm-25ga-370-dc-gear-motor/12v-60-rpm-25ga-370-dc-gear-motor-1-1100x1100.webp`,
...
Category:"gear motor"
     ...
     { id: 6, img:`https://www.flyrobo.in/image/cache/wp/ge/c1a-reduction-gearbox-gear-motor/c1a-reduction-gearbox-gear-motor-5-1100x1100.webp`,
...
Category:"respberry pi display touch Screen"
      ...
      <div className="container ">
        <div className="row">
          <div className="col-12 nav-item">
                ...
                <a href="#wireless">Wireless Module</a>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="https://www.flyrobo.in/image/cache/wp/gp/Banner/arduino-slider-1920x900w.webp" class="d-block w-100 banner" alt="..."/>
    </div>
    <div class="carousel-item">
      <img src={banner2} class="d-block w-100 banner" alt="..."  />
    </div>
    <div class="carousel-item">
      <img src="https://www.flyrobo.in/image/cache/wp/gj/Banner/3d-printer-and-cnc-1920x900w.webp" class="d-block w-100 banner" alt="..."  />
    </div>
  </div>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next">
    ...
    <span class="visually-hidden">Next</span>
        ...
        <div className="container">
          ...
          <div className="col-12 mt-4 card-container ms-2" id='electronic' >
            
            {Products1.map((item, index) => (
              <Product key={item.id} details={item} />
            ))}
          </div>
          <div className="col-12 card-container ms-2 mt-5" id='module'>
          ...
          <div className="col-12 card-container ms-2 mt-5" id='controllers'>
          ...
          <div className="col-12 card-container ms-2 mt-5" id='wireless'>
          ...
          <div className="col-12 mt-3">
            ...
            <div className="col-12 card-container ms-2 mt-5" id='sensor'>
            {Products5.map((item, index) => (
              <Product key={item.id} details={item} />
            ))}
          </div>
            <div className="col-12 card-container ms-2 mt-3" id='wireless'>
            {Products6.map((item, index) => (
              <Product key={item.id} details={item} />
            ))}
          </div>
          <div className="col-12 mt-5 ms-3">
           ...
           <div className="col-12 card-container ms-2 mt-3" id='driver'>
            {Products7.map((item, index) => (
              <Product key={item.id} details={item} />
            ))}
          </div>
          <div className="col-12 mt-5 ms-3 ">
