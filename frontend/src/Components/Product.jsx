...
const Product = ({ details }) => {
  ...
  const view = () => {
    navigate('/view', { state: { product: details } });
  };

  const addToCart = (e) => {
    e.stopPropagation();
    let cart = JSON.parse(localStorage.getItem('cart')) || [];
    const existingIndex = cart.findIndex(item => item.id === details.id);
  ...
  return (
    <div className='card-tool' onClick={view}>
      <div className="container">
        <div className="row d-flex justify-content-center">
          <div className="col-5 card d-flex justify-content-center">
            ...
            <h6 className='mt-1'>{details.name}</h6>
            ...
            <button className='btn     btn-primary' onClick={orderNow} >Order</button>
             <div className="col-2 cardbtn" onClick={addToCart}>
